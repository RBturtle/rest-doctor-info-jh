...
/**
 * Test for /turtle_species/{id}
 */
Test('/turtle_species/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200, 405
         */
        t.test('test getturtle_species get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/turtle_species/{id}']['get']['responses']['200']['schema']);
